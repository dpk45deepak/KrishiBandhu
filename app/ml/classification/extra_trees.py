...
class ExtraTreesClassifier(ClassificationModel):
    """
    Extra Trees Classifier wrapper with unified interface.
    """
    ...
    def fit(
        ...
        try:
            ...
            raise TrainingError(f"Extra Trees training failed: {str(e)}") from e
    ...
    def get_model(self) -> SklearnExtraTrees:
